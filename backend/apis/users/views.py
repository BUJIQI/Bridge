...
def commit_decision(request):
    ...
    data_update_decision_data={
        ...
        'ctl00$contentplaceholderadd$rsd5': production_plan_qty,
        'ctl00$contentplaceholderadd$zbd5': production_line_investment,
        'ctl00$contentplaceholderadd$end5': production_line_change,
        'ctl00$contentplaceholderadd$eld5': maintenance_cost,
        'ctl00$contentplaceholderadd$vad5': production_optimization_investment,
        'ctl00$contentplaceholderadd$pnd5': production_staff_recruitment,
        'ctl00$contentplaceholderadd$smd5': production_staff_resignation ,
        'ctl00$contentplaceholderadd$swd5': purchase_robot,
        'ctl00$contentplaceholderadd$ikd5': raw_material_purchase_qty,
        'ctl00$contentplaceholderadd$rkd5': purchase_accessories,
        'ctl00$contentplaceholderadd$nsd5': research_staff_recruitment,
        'ctl00$contentplaceholderadd$nld5': research_staff_resignation,
        'ctl00$contentplaceholderadd$rbd5': product_improvement_cost, 
