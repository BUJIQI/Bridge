  ...
  <div v-else>  
    <div class="panel panel-default mt-3" v-if="userInfo.cycle > 1">
      <div class="panel-heading">
        <h3 class="panel-title">成本发生部门核算报告（第{{ selectedCycle }}周期）</h3>
      ...
      <div class="panel-body">
        <div class="table-container">
          <table>
            <thead>
              <tr>
                <th class="diagonal-header">
                    <span class="bottom-left">成本类型</span>
                    <span class="top-right">成本发生部门</span>
                </th>
                <th>合计（百万元）</th>
                <th>采购</th>
                <th>生产</th>
            ...
            <tbody>
              <tr>
                <td colspan="7" class="subheader">人员费用</td>
              </tr>
              <tr>
                <td>工资费用</td>
              ...
              <tr>
                <td colspan="7" class="subheader">折旧费用</td>
              </tr>
              <tr>
                <td>厂房</td>
              ...
              <tr>
                <td colspan="7" class="subheader">其它经营费用</td>
              </tr>
              <tr>
                <td>其它固定费用</td>
              ...
              <tr class="summary">
                ...
                <td>{{ currentReportData[84] }}</td>          
                <td>{{ currentReportData[85] }}</td>
                <td>{{ currentReportData[86] }}</td>
                <td>{{ currentReportData[87] }}</td>
                <td>{{ currentReportData[88] }}</td>
                <td>{{ currentReportData[89] }}</td>
              </tr>
            </tbody>
          </table>
        </div>
  ...
  setup() {
    ...
    const fetchReportData = async () => {
      try {
        ...
        reportData.value = response.data['成本发生部门核算报告'];  
      } catch (error) {
    ...
    const currentReportData = computed(() => {
      return reportData.value[`成本发生部门核算报告（第${selectedCycle.value}周期）`] || [];
    });    
